class FriendshipsController < BaseController
  ...
  def index
    ...
    respond_to do |format|
      format.html {redirect_to accepted_user_friendships_path(:user_id => params[:id] || params[:user_id] )}
      format.xml { render :action => 'index.xml', :layout => false} # Not working, no such template exists
    end
  end
